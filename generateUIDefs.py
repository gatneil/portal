...
for environment in imageList:
    ...
    subprocess.call(['cp', 'vnet.json', 'lbtrue.json', 'lbfalse.json', 'sa.json', 'vmsstrue.json', 'vmssfalse.json', 'autoscale.json', 'autoscaleHelper.json', 'null.json', subRoot + 'Artifacts/'])
