...
for environment in imageList:
    ...
    subprocess.call(['cp', 'NoManagedtrue.json', 'YesManagedtrue.json', 'NoManagedfalse.json', 'YesManagedfalse.json', 'NoUnmanagedfalse.json', 'YesUnmanagedfalse.json', subRoot + 'Artifacts/'])
