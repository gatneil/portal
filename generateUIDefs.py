...
for environment in imageList:
    ...
    subprocess.call(['cp', 'NoManagedfalse.json', 'YesManagedfalse.json', 'NoManagedtrue.json', 'YesManagedtrue.json', 'NoUnmanagedtrue.json', 'YesUnmanagedtrue.json', subRoot + 'Artifacts/'])
